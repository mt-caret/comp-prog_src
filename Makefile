...
cpflags := -V include-after='<script src="https://utteranc.es/client.js" repo="mt-caret/comp-prog" issue-term="title" theme="github-light" crossorigin="anonymous" async></script>'
